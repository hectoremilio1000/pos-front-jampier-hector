 ...
 *  - POST   /productionMonitors           body { code, name, mode, isEnabled }
 *  - PUT    /productionMonitors/:id       body { code?, name?, mode?, isEnabled? }
...
export default function ProductionMonitors() {
  ...
  function openEdit(m: ProductionMonitor) {
    setEditing(m)
    form.setFieldsValue({ code: m.code, name: m.name, mode: m.mode, isEnabled: m.isEnabled })
    setIsModalOpen(true)
  }
