 ...
 * - Base: VITE_API_INVENTORY_BASE (ej: http://localhost:3343)
...
function getApiBase(): string {
  const raw = (import.meta as any).env?.VITE_API_INVENTORY_BASE as string | undefined;
  const base = raw?.trim() || "http://localhost:3343";
